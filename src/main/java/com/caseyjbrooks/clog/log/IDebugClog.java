...
public interface IDebugClog extends ICommonClog {
     ...
     * @return int
     */
    default int d(Throwable throwable) {
     ...
     * @return int
     */
    default int d(String message, Object... args) {
     ...
     * @param args (optional) the arguments to pass to the formatter
     */
    default int d(String message, Throwable throwable, Object... args) {
