...
public interface IFatalClog extends ICommonClog {
     ...
     * @return int
     */
    default int wtf(Throwable throwable) {
     ...
     * @return int
     */
    default int wtf(String message, Object... args) {
     ...
     * @param args (optional) the arguments to pass to the formatter
     */
    default int wtf(String message, Throwable throwable, Object... args) {
