...
public interface IInfoClog extends ICommonClog {
     ...
     * @return int
     */
    default int i(Throwable throwable) {
     ...
     * @return int
     */
    default int i(String message, Object... args) {
     ...
     * @param args (optional) the arguments to pass to the formatter
     */
    default int i(String message, Throwable throwable, Object... args) {
